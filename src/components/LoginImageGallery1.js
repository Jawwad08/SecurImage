  ...
  const filteredImages = selectedCategory
    ...
    return (
      <div>
        ...
        <button disabled={!selectedImage || selectedCategory === null} onClick={() => { navigate('/loginImageGallery2', { state: { email: location.state.email, password: location.state.password, category1: selectedCategory, image1: selectedImage } }) }}>Ok</button>
      </div>
    );
};

export default LoginImageGallery1;