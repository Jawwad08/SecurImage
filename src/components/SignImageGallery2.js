  ...
  return (
    <div>
      <div className="container mt-4">
        ...
        <button disabled={!selectedImage || selectedCategory===null} onClick={()=>{navigate('/SignImageGallery3',{state:{email:location.state.email,password:location.state.password,category1:location.state.category1,image1:location.state.image1,category2:selectedCategory,image2:selectedImage}})}}>Ok</button>
      </div>
    </div>
  );
};

export default SignImageGallery2;
