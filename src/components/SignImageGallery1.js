  ...
  const filteredImages = selectedCategory
    ...
    return (
      <div>
        ...
        <button disabled={!selectedImage || selectedCategory === null} onClick={() => { navigate('/SignImageGallery2', { state: { email: location.state.email, password: location.state.password, category1: selectedCategory, image1: selectedImage } }) }}>Ok</button>
      </div>
    );    
};

export default SignImageGallery1;